...
echo -e "\n\n############ Auto Install Script for Elixir Network ############\n"
sleep 2
...
read -p "Enter your Wallet Public Key: " wallet_pub_key
...
log "info" "===== Elixir Validator Setup Notification Complete ====="
log "info" "===== Joint For Other Auto script https://t.me/winsnip ====="
